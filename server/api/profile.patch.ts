...
const schema=z.object({fullName:z.string().min(1).optional(), username:z.string().min(1).optional(), password:z.string().min(4).optional().or(z.literal('')), profileImage:z.string().nullable().optional()})
