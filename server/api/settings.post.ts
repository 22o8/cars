...
const schema=z.object({dealerName:z.string().min(1), phone:z.string().optional().default(''), address:z.string().optional().default(''), usdToIqdRate:z.number().default(1), logoUrl:z.string().optional().default('')})
