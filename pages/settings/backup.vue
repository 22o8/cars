...
const {data,refresh}=useFetch<any[]>('/api/backups',{default:()=>[]}); const confirmCode=ref(''); const message=ref(''); const messageType=ref<'ok'|'error'>('ok'); const busy=ref(false); const backupFile=ref<any|null>(null)
